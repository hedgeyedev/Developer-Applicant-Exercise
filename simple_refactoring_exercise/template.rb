...
#
# 4. Again, without context, I'd say the module's template method would
...
module Template
  def template(source_template, req_id)
    ...
    template_part_one + altcode + template_part_two # looks like, appending part two is not covered in testing
  end
end
